  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center justify-center pt-20 pb-16 overflow-hidden">
      ...
      <Container className="relative z-10 flex flex-col items-center text-center gap-8">
        <ScrollReveal>
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-(--border-default) bg-(--bg-surface)/50 backdrop-blur-sm text-sm font-medium text-(--text-secondary) mb-4">
        ...
        <ScrollReveal delay={0.1} className="flex flex-col items-center gap-4">
          <GradientText
            as="h1"
            className="text-gray-900 text-4xl font-extrabold md:text-5xl lg:text-6xl"
          >
            Zaidibeth Ramos
          </GradientText>
